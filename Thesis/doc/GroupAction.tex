\subsection{The group action of $\var{PGL}_n$ on $\proj^n_k$}
...
We finish this section by listing some properties which are stable under projective transformation.
